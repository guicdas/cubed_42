...
/*   Updated: 2024/06/11 22:14:09 by gcatarin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_char(char c)
{
	...
	{
		if (c == 'N')
			init_orientation(3 * PI / 2 + 0.01, 0.66, 0);
		else if (c == 'S')
			init_orientation(PI / 2 + 0.01, -0.66, 0);
		else if (c == 'W')
			init_orientation(PI + 0.01, 0, -0.66);
		else if (c == 'E')
			init_orientation(0.01, 0, 0.66);
		return (2);
	}
	else
		return (0);
